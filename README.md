...
[![Build](https://github.com/step-security/auto-author-assign/actions/workflows/build.yml/badge.svg)](https://github.com/step-security/auto-author-assign/actions/workflows/build.yml)
![GitHub Release](https://img.shields.io/github/v/release/step-security/auto-author-assign)
...
jobs:
  assign-author:
    runs-on: ubuntu-slim
    steps:
      - uses: step-security/auto-author-assign@v3
```
